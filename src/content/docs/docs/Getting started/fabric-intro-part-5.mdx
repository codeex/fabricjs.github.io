...
import code1 from './5-1.js?raw';
import code4 from './5-4.js?raw';
...
<CodeEditor code={code1} canvasId="step1" client:idle autoRun={true} runOnChange={false} >
<canvas  width="400" height="300" id="step1"></canvas>
</CodeEditor>
...
<CodeEditor code={code4} canvasId="step4" client:idle autoRun={true} runOnChange={false} >
<canvas id="step4" width="400" height="400"></canvas>
</CodeEditor>