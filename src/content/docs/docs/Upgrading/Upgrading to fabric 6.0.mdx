---
date: '2024-06-29'
title: '升级到 FabricJS 6.0'
description: '理解FabricJS 6.0升级后的常见变化和更改，升级步骤等'
---
...
如果您有一个大型项目，并且进行了大量自定义和子类化，升级将会很困难，对此我们表示歉意。🙇🙇🙇

更详细的变化列表在这里：[#8299](https://github.com/fabricjs/fabric.js/issues/8299)。
